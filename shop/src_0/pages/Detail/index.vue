  ...
  methods: {
    ...
    async addShopCar(){
      ...
      /*
        ...
        上面的代码：调用仓库中的addOrUpdateShopCar函数，这个方法加上async，返回一定是一个Promise
      */
      try{
        let result = await this.$store.dispatch('addOrUpdateShopCar', {skuId:this.$route.params.skuid, skuNum:this.skuNum})
        //进行路由跳转
